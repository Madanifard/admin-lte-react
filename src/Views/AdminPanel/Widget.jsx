...
import {faR, faEnvelope, faFlag, faCopy, faStar, faBook, faBookmark, faThumbsUp, faCalendarAlt, faComments, faShoppingCart, faArrowAltCircleRight, fas, faUserPlus, faChartPie, faSyncAlt, faPlus, faMinus, faTimes, faExpand, faCircle, faShare} from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="row">
          ...
          <div className="col-md-3 col-sm-6 col-12">
            <div className="info-box">
              ...
              <FontAwesomeIcon icon={(far, faFlag)}  />
              </span>
              <div className="info-box-content">
        ...
        <div className="row">
          <div className="col-md-3 col-sm-6 col-12">
            <div className="info-box bg-info">
              ...
              <FontAwesomeIcon icon={(far, faBookmark)}  />
          ...
          <div className="col-md-3 col-sm-6 col-12">
            <div className="info-box bg-danger">
              <span className="info-box-icon">
              <FontAwesomeIcon icon={(far, faComments)}  />
        ...
        <div className="row">
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-info">
              ...
              <div className="icon">
              <FontAwesomeIcon icon={(far, faShoppingCart)}  />  
              </div>
              <a href="#" className="small-box-footer">
                More info 
                <FontAwesomeIcon icon={(far, faArrowAltCircleRight)}  />  
              </a>
            </div>
          </div>
          {/* ./col */}
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-success">
              ...
              <a href="#" className="small-box-footer">
                More info 
                <FontAwesomeIcon icon={(fas, faArrowAltCircleRight)}  />  
          ...
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-warning">
              ...
              <div className="icon">
              <FontAwesomeIcon icon={(far, faUserPlus)}  />    
          ...
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-danger">
              ...
              <div className="icon">
              <FontAwesomeIcon icon={(far, faChartPie)}  />    
        ...
        <div className="row">
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-info">
              ...
              <FontAwesomeIcon icon={(fas, faSyncAlt)}  />
              ...
              <a href="#" className="small-box-footer">
                More info <FontAwesomeIcon icon={(far, faArrowAltCircleRight)}  />
              </a>
            </div>
          </div>
          {/* ./col */}
          ...
          <div className="col-md-3">
            <div className="card card-success">
              <div className="card-header">
                ...
                <div className="card-tools">
                  <button type="button" className="btn btn-tool" data-card-widget="collapse">
                  <FontAwesomeIcon icon={(far, faMinus)}  />
            ...
            <div className="card card-warning">
              <div className="card-header">
                ...
                <div className="card-tools">
                  ...
                  <FontAwesomeIcon icon={(far, faTimes)}  />
            ...
            <div className="card card-danger">
              <div className="card-header">
                ...
                <div className="card-tools">
                  ...
                  <FontAwesomeIcon icon={(far, faExpand)}  />
                  </button>
                </div>
                {/* /.card-tools */}
              </div>
            ...
            <div className="card card-primary">
              <div className="card-header">
                ...
                <div className="card-tools">
                  ...
                  <FontAwesomeIcon icon={(far, faSyncAlt)}  />
          ...
          <div className="col-md-3">
            <div className="card card-success">
              <div className="card-header">
                ...
                <div className="card-tools">
                  <button type="button" className="btn btn-tool" data-card-widget="remove"><FontAwesomeIcon icon={(far, faTimes)}  />
                  </button>
                </div>
                {/* /.card-tools */}
              </div>
          ...
          <div className="col-md-6">
            ...
            <div className="card card-widget">
              ...
              <div className="card-body">
                ...
                <FontAwesomeIcon icon={(fas, faShare)}  />
                 Share</button>
                <button type="button" className="btn btn-default btn-sm">
                <FontAwesomeIcon icon={(far, faThumbsUp)}  />
                 Like</button>
          ...
          <div className="col-md-6">
            ...
            <div className="card card-widget">
              ...
              <div className="card-body">
                ...
                <button type="button" className="btn btn-default btn-sm"><FontAwesomeIcon icon={(fas, faShare)}  /> Share</button>
                <button type="button" className="btn btn-default btn-sm"><FontAwesomeIcon icon={(far, faThumbsUp)}  /> Like</button>
