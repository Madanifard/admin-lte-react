      ...
      >
        <li className="nav-item menu-open">
          <a href="#" className="nav-link active">
            <FontAwesomeIcon icon={(fas, faTachometerAlt, faNavicon)} spin />
            <p>
              Dashboard
              <FontAwesomeIcon icon={(fas, faAngleLeft)} spin />
            </p>
          </a>
          <ul className="nav nav-treeview">
            <li className="nav-item">
              <a href="./index.html" className="nav-link">
                <FontAwesomeIcon icon={(fas, faCircle, faNavicon)} spin />
                <p>Dashboard v1</p>
              </a>
            </li>
            <li className="nav-item">
        ...
        <li className="nav-item">
          <a href="pages/widgets.html" className="nav-link">
            <FontAwesomeIcon icon={(fas, faNavicon, faTh)} spin />
            <p>
              Widgets
        ...
        <li className="nav-item">
          <a href="#" className="nav-link">
            <FontAwesomeIcon icon={(fas, faNavicon, faCopy)} spin />
            <p>
              Layout Options
          ...
          <ul className="nav nav-treeview">
            <li className="nav-item">
              <a href="pages/layout/top-nav.html" className="nav-link">
                <FontAwesomeIcon icon={(faR, fas, faNavicon, faCircle)} spin />
                <p>Top Navigation</p>
              </a>
            </li>
            <li className="nav-item">
              <a href="pages/layout/top-nav-sidebar.html" className="nav-link">
                <FontAwesomeIcon icon={(faR, faNavicon, faCircle)} spin />
        ...
        <li className="nav-item">
          <a href="#" className="nav-link">
            <FontAwesomeIcon icon={(fas, faNavicon, faChartPie)} spin />
            <p>
              Charts
          ...
          <ul className="nav nav-treeview">
            <li className="nav-item">
              <a href="pages/charts/chartjs.html" className="nav-link">
                <FontAwesomeIcon icon={(faR, faCircle, faNavicon)} spin />
                <p>ChartJS</p>
              </a>
            </li>
            <li className="nav-item">
